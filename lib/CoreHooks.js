...
class CoreHooks {
  ...
  load() {
    ...
    self.proxyOff();
    self.sls = self.proxy(self.sls, "core");
    self.co.push("pluginManager"); // pluginManager required (i.e. mandatory)
  ...
  attachHooks(object, event) {
    ...
    return function () {
      ...
      self.executeHooks("before" + suffix, arguments);
      let result = object[event](...Object.values(arguments));
      self.executeHooks("after" + suffix, arguments);
      return result;
    }
  }
